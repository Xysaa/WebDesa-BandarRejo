...
<div class="max-w-3xl">
    <h2 class="text-3xl font-bold text-gray-800 mb-6">Tambah Berita Baru</h2>
        ...
        <form action="{{ route('dashboard.berita.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                <label for="slug" class="block text-gray-700 font-semibold mb-2">
                    Slug <span class="text-gray-500 text-sm">(Opsional, otomatis generate dari judul)</span>
                </label>
                <input 
                    type="text" 
                    id="slug" 
            ...
            <div class="mb-6">
                <label for="image" class="block text-gray-700 font-semibold mb-2">
                    Gambar Berita <span class="text-gray-500 text-sm">(jpeg, png, jpg, gif - max 2MB)</span>
                </label>
                <input 
                    type="file" 
                    id="image" 
