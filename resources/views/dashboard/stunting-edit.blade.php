...
<div class="max-w-2xl mx-auto">
    ...
    <div class="bg-white rounded-lg shadow-lg p-8">
        <h3 class="text-2xl font-bold text-[#2C7961] mb-6">Edit Data Stunting</h3>
        ...
        <form action="{{ route('dashboard.stunting.update', $dataStunting->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="mb-6">
                ...
                <input type="text" 
                       ...
                       value="{{ old('nama_dusun', $dataStunting->nama_dusun) }}"
                       required>
                @error('nama_dusun')
            ...
            <div class="mb-6">
                ...
                <input type="number" 
                       ...
                       min="0" 
                       value="{{ old('jumlah_anak_stunting', $dataStunting->jumlah_anak_stunting) }}"
                       required>
            ...
            <div class="mb-6">
                ...
                <input type="number" 
                       ...
                       min="2000" 
                       max="{{ date('Y') + 1 }}" 
                       value="{{ old('tahun', $dataStunting->tahun) }}">
                @error('tahun')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-6">
                ...
                <textarea id="keterangan" 
                          name="keterangan" 
                          rows="4" 
                          class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#2C7961] focus:border-transparent @error('keterangan') border-red-500 @enderror">{{ old('keterangan', $dataStunting->keterangan) }}</textarea>
                @error('keterangan')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
