  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6 lg:gap-8 mb-8">
    @foreach($berita as $item)
      ...
      <a href="/berita/{{ $item['slug'] }}"
        ...
        <div class="p-4 sm:p-5 pr-0 md:pr-28 lg:pr-36">
        ...
        <!-- Badge tanggal: TAMPIL NORMAL DI MOBILE (di bawah konten), ABSOLUTE DI MD+ -->
        <div class="px-4 pb-4 sm:px-5 sm:pb-5 md:px-0 md:pb-0">
          <!-- Mobile/tablet kecil: inline-block, tidak menekan judul -->
          <div class="md:hidden inline-block bg-gradient-to-br from-emerald-600 to-emerald-300 text-white rounded-xl px-3 py-2 leading-tight text-center shadow-md ring-1 ring-emerald-500/20">
        ...
        <!-- Mulai md: absolute di pojok kanan bawah, barulah kita sisihkan ruang via pr di atas -->
        <div class="hidden md:block absolute bottom-0 right-0 z-10">
          <div class="bg-gradient-to-br from-emerald-600 to-emerald-300 text-white rounded-tl-xl rounded-br-xl px-3 sm:px-4 py-2 leading-tight text-center shadow-md ring-1 ring-emerald-500/20">
            <div class="text-xs sm:text-sm font-semibold" style="font-family: 'Poppins', sans-serif;">{{ $hari }} {{ $bln }}</div>
            <div class="text-xs sm:text-sm font-bold" style="font-family: 'Poppins', sans-serif;">{{ $thn }}</div>
          </div>
        </div>
      </a>
    @endforeach
...
<style>
  ...
  /* Judul: 3 baris di mobile, 4 di tablet, bebas di desktop */
  .title-clamp {
    display: -webkit-box;
    -webkit-box-orient: vertical;
    overflow: hidden;
  ...
  @media (max-width: 640px) {
    .title-clamp { -webkit-line-clamp: 3; }
  }
  @media (min-width: 641px) and (max-width: 1024px) {
    .title-clamp { -webkit-line-clamp: 4; }
  }
  ...
  /* Keterbacaan umum di layar kecil */
  #berita-container { word-break: break-word; }
  @media (max-width: 480px) {
    #berita-container p, #berita-container li { line-height: 1.6; }
  }
  @media (hover: none) {
